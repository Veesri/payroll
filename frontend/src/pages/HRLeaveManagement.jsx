...
import { FaCheckCircle, FaTimesCircle, FaCalendarCheck, FaDownload } from 'react-icons/fa';
            ...
            <div className="slide-up-animation">
                <div className="d-flex justify-content-between align-items-center mb-5">
                    <div>
                        ...
                        <p className="text-muted">Review and process employee leave requests</p>
                    </div>
                    ...
                    <div className="table-responsive">
                        <table className="table table-borderless table-hover text-white align-middle">
                            ...
                            <tbody>
                                {leaves.map(leave => (
                                    <tr key={leave.id}>
                                        <td className="fw-bold">{leave.employee_name}</td>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content border-0 shadow-lg" style={{ background: 'rgba(20, 20, 30, 0.98)', backdropFilter: 'blur(10px)' }}>
                            <div className="modal-header border-bottom border-secondary">
                                <h5 className="modal-title fw-bold text-capitalize text-white">{action} Leave Request</h5>
                                <button type="button" className="btn-close btn-close-white" onClick={() => setShowModal(false)}></button>
                            </div>
                            <div className="modal-body p-4">
                                <div className="mb-4">
                                    <h6 className="text-white">Employee: <span className="text-light fw-normal">{currentLeave.employee_name}</span></h6>
